...
class Matrix
{
	...
	static rotation(quat)
	{
		...
		//Big brain math from this website
			...
			var cell_1 = 2*quat.x*quat.y + 2*quat.z*quat.w;
			var cell_2 = 2*quat.x*quat.z - 2*quat.y*quat.w;

			var cell_3 = 2*quat.x*quat.y - 2*quat.z*quat.w;
			var cell_4 = 1 - 2*quat.x*quat.x - 2*quat.z*quat.z;
			var cell_5 = 2*quat.y*quat.z + 2*quat.x*quat.w;

			var cell_6 = 2*quat.x*quat.z + 2*quat.y*quat.w;
			var cell_7 = 2*quat.y*quat.z - 2*quat.x*quat.w;
			var cell_8 = 1 - 2*quat.x*quat.x - 2*quat.y*quat.y;
